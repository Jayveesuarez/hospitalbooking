...
import HOSPITAL from "./photos/bg01.jpg";
import TREATMENT from "./photos/bg1.jpg";
import "./homePage.css";
      ...
      <div id="carousel">
        <div className="slides">
          <div className="slide">
            ...
            <h1 className="text">"Welcome to MedConnect Appointments  your healthcare scheduling solution."</h1>
          </div>
          <div className="slide">
